...
describe('pages/tableau-export-csv/TableauExportCsv', () => {
  beforeEach(() => {
    const TableauExportCsv = proxyquire('pages/tableau-export-csv/TableauExportCsv', {
      'services/dao': daoStub
    });

    page = new TableauExportCsv('some path', req, res);
  });

  describe('#url', () => {
    it('returns correct url', () => {
      expect(page.url).to.eql(paths.tableauExportCsv);
    });
  });
